...
<main>
	<section class="hero">
		...
		<Container>
			...
			<p>
				Esperamos que o app que estamos criando torne a organização do seu casamento mais fácil,
				leve e até divertida. <br /><br />
				Fique de olho no seu email, vamos enviar atualizações sobre o desenvolvimento do app e, claro,
				avisar quando ele estiver disponível para download.
			</p>
		</Container>
	</section>
</main>
